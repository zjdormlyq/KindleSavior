...
var ALAPI_TOKEN = "swvrtSZeILFuEhTE";
    ...
    if (this.readyState == 4) {
      ...
      if (data.code === 200) {
        ...
        var weaTemp =
          ...
          "<div>当前气温</div>";
        var highTemp = weather_data.max_temp;
        var lowTemp = weather_data.min_temp;
        var air = weather_data.aqi.air;
        air = air ? air : "未知";
        var airLevel = weather_data.aqi.air_level;
        airLevel = airLevel && air ? airLevel : "";
        var updateTime = weather_data.update_time.split(" ");
    ...
    if (this.readyState == 4) {
      ...
      if (data.code === 200) {
        ...
        for (var i = 0; i < weibo_num; i++) {
          var index = i + 1;
          hot_word.innerHTML +=
            "<li>" + index + ". " + weibo_data[i].hot_word + "</li>";
          hot_word_num.innerHTML +=
            "<li>" + weibo_data[i].hot_word_num + "</li>";
        }
      } else {
